...
class ModifierFactureModal extends Component {
    constructor(props) {
        super(props);
        this.state = {
            codearticle: "",
                                            ...
                                            </Row>
                                            {
                                                this.state.des === '' ?
                                                    <Center>
                                                        <Button disabled
                                                            style={{ width: "250px" }}
                                                            variant="contained" color="primary" type="submit" >Ajouter</Button>
                                                    </Center>
                                                    :
                                                    <Center>
                                                        <Button
                    ...
                    <Modal.Footer>

                        {
                            !this.state.btnEnabled ?
                                ...
                                >Enregistrer</Button>
                                :
                                <Button variant="contained" style={{ backgroundColor: "rgb(0, 8, 126)", color: "white", width: "30%" }}
...
export default connect(mapStateToProps, mapDispatchToProps)(ModifierFactureModal);
