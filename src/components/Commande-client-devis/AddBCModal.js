                        ...
                        <form>
                                            ...
                                            <FormGroup style={{ marginTop: "25px" }}>
                                                <Typography component="div">
                                                    <Grid
                                                        ...
                                                        spacing={1}
                                                    >
                                                        <Grid item style={{ color: "grey" }}>Raison sociale</Grid>
                                                        <Grid item>
                                                            <Switch
                            ...
                            <Card style={{ marginTop: "10px" }}>
                                <Card.Body>
                                    <Row>
                                        <Col sm={3}
                                            ...
                                            <p style={{ color: "grey", marginBottom: "-5px" }}>
                                                Total HT Brut</p>
                                            <p style={{ color: "black", }}>
                                                {roundTo(this.state.totalhtbrut, 3)}</p>
                                        </Col>
                                        ...
                                        <Col sm={3}
                                            ...
                                            <p style={{ color: "grey", marginBottom: "-5px" }}>
                                                Remise Article</p>
                                            <p style={{ color: "black", }}>
                                                {roundTo(this.state.sumremisearticle, 3)}</p>
                                        </Col>
                                        ...
                                        <Col sm={3}
                                            ...
                                            <p style={{ color: "grey", marginBottom: "-5px" }}>
                                                Total TVA</p>
                                            <p style={{ color: "black", }}>
                                                {roundTo(this.state.totaltva, 3)}</p>
                                        </Col>
                                    ...
                                    <Row>
                                        <Col sm={3}>
                                            <Divider style={{ marginTop: "-8px", backgroundColor: "grey" }}></Divider>
                                        </Col>
                                        <Col sm={3}>
                                            <Divider style={{ marginTop: "-8px", backgroundColor: "grey" }}></Divider>
                                        </Col>
                                    ...
                                    <Row style={{ marginBottom: "-25px" }}>
                                        <Col sm={3}
                                            ...
                                            <p style={{ color: "grey", marginBottom: "-5px" }}>
                                                Total HT Net</p>
                                            <p style={{ color: "black", }}>
                                                {roundTo(this.state.totalhtnet, 3)}</p>
                                        </Col>
                                        ...
                                        <Col sm={3}
                                            ...
                                            <p style={{ color: "grey", marginBottom: "-5px" }}>
                                                Remise Globale</p>
                                            <p style={{ color: "black", }}>
                                                {roundTo(this.state.remiseglobal, 3)}</p>
                                        </Col>
