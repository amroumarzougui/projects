  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        >
          <Alert onClose={this.snackbarClose}
            severity="success">
        ...
        >
          <Modal.Header
            closeButton
            style={{ backgroundColor: "#F2F3F3", color: "#222", fontSize: "16px" }}
          >
            <b>Nouveau message</b>
          </Modal.Header>
          <Modal.Body>
              ...
              <Col sm={12}>
                <Form onSubmit={this.submitHandler} >
                  <Row>
                    ...
                    <Col sm={10}>
                      <input name="email"
                        onChange={this.handleChange} className="inputmail" type="text"></input>
                    </Col>
                  </Row>
                  ...
                  <Row style={{ marginTop: "5px" }}>
                    ...
                    <Col sm={10}>
                      <textarea rows="10" name="message"
                        onChange={this.handleChange} className="textareamail" type="text" />
                    </Col>
                  </Row>
